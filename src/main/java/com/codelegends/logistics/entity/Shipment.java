 ...
 */
// Registers Shipment as a persistent JPA entity.
@Entity
// Defines the database table metadata used for customer shipment rows.
@Table(name = "shipment")
// Generates read accessors for persisted customer shipment properties.
@Getter
